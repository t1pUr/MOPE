...
x_aver_max = (15 + 35 + 30)/ 3
x_aver_min = (-5 - 15 + 15) / 3
...
def main(n, m):
    ...
    if F_p < f_t:
        ...
        x_range = [(-5*1.7, 15*1.7), (-15*1.7, 35*1.7), (15*1.7, 30*1.7)]
        x_aver_max = (15*1.7 + 35*1.7 + 30*1.7) / 3
        x_aver_min = (-5*1.7 - 15*1.7 + 15*1.7) / 3
        main(4, 4)
